 ...
 */
function generateServiceTemplate(entityName) {
...
class ${serviceClassName} extends GetxService {
  ...
  final String _baseUrl = 'https://api.yourapp.com/api';
...
function main() {
    const argv = yargs(hideBin(process.argv))
        .usage('Usage: $0 <jdlFile> [outputDir]')
    ...
    console.log(`Generating files in '${outputDir}' directory...`);
    ...
    for (const [entityName, fields] of Object.entries(entities)) {
        ...
        const serviceContent = generateServiceTemplate(entityName);
    ...
    console.log("3. IMPORTANT: Update the '_baseUrl' in your generated service files.");
